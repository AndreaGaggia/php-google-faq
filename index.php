<?php 
    $q_a = [
        [
            "question" => "Come state implementando la recente decisione della Corte di
                giustizia dell'Unione europea (CGUE) relativa al diritto
                all'oblio?",
            "answer" => [
...
<html lang="en">
    <head>
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@400;700&family=Roboto&display=swap"
            rel="stylesheet"
        />
    ...
    <body>
        ...
        <main>
            <?php 
                foreach ($q_a as $block => $values) { ?>                 
                    <h2> <?php echo $values["question"] ?> </h2>
                    <?php 
                    
                        foreach ($values["answer"] as $paragraph) { ?>
